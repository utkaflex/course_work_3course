...
import RoomTypeTable from "@/components/room-type-table/room-type-table";
  ...
  const tabs = [
    {
      ...
      children: <EquipmentTable variant="main" showFilters={true} userRole={userRole}/>,
      min_needed_role: 2
    },
    {
    ...
    {
      value: "category",
      tab_text: "Категории оборудования",
      description: "Здесь вы можете просмотреть все доступные категории оборудования",
    ...
    },
    {
      value: "room",
      tab_text: "Помещения",
      description: "Здесь вы можете просмотреть все доступные помещения",
      children: <RoomTable/>,
      min_needed_role: 3
    },
    {
      value: "room_type",
      tab_text: "Типы помещений",
      description: "Здесь вы можете просмотреть все доступные типы помещения",
      children: <RoomTypeTable/>,
      min_needed_role: 3
    },
    {
