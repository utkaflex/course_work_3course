...
interface RoomTypeDataTableProps<TData, TValue> {
  columns: ColumnDef<TData, TValue>[]
  data: TData[]
}

export function RoomTypeDataTable<TData, TValue>({
                                                   columns,
                                                   data,
                                                 }: RoomTypeDataTableProps<TData, TValue>) {
      ...
      <div className="w-full h-full">
        ...
        <div className="flex items-center justify-end space-x-2 py-4">
          <div className="flex-1 text-sm text-muted-foreground">
            ...
            {Math.max(table.getPageOptions().length, 1)}{" "}
            {CorrectPagesCase(table.getPageOptions().length)}
          </div>
